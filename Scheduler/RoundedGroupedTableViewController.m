// Zachary Thompson
//
//  RoundedGroupedTableViewController.m
//  Scheduler
//
...
@interface RoundedGroupedTableViewController ()

@end

@implementation RoundedGroupedTableViewController
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if ([cell respondsToSelector:@selector(tintColor)]) {
        if (tableView == self.tableView) {
            ...
            BOOL addLine = NO;
            // if it is the first row and only one row in this section
            if (indexPath.row == 0 && indexPath.row == [tableView numberOfRowsInSection:indexPath.section]-1) {
                ...
                // else it is neither the first nor last row
            } else {
